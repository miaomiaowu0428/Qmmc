...
mod tests {
    ...
    use crate::analyze::lex::token::TokenType::{
        AndKeyword, FalseKeyword, FloatPointToken, IntegerToken, LeftParenthesisToken, OrKeyword,
        PlusToken, RightParenthesisToken, SemicolonToken, SlashToken, StarToken, TrueKeyword,
    };
    ...
    fn test() {
        ...
        assert_eq!(
            tokens[2],
            Token::new(LeftParenthesisToken, "(".to_string(), 0, 0)
        );
        ...
        assert_eq!(
            tokens[6],
            Token::new(RightParenthesisToken, ")".to_string(), 0, 0)
        );
        ...
        assert_eq!(
            tokens[10],
            Token::new(TrueKeyword, "true".to_string(), 0, 0)
        );
        assert_eq!(tokens[11], Token::new(AndKeyword, "and".to_string(), 0, 0));
        assert_eq!(
            tokens[12],
            Token::new(FalseKeyword, "false".to_string(), 0, 0)
        );
        ...
        assert_eq!(
            tokens[15],
            Token::new(SemicolonToken, ";".to_string(), 0, 0)
        );
        assert_eq!(
            tokens[16],
            Token::new(LeftParenthesisToken, "(".to_string(), 0, 0)
        ...
        assert_eq!(
            tokens[17],
            Token::new(FloatPointToken, "10.0".to_string(), 0, 0)
        );
        assert_eq!(tokens[18], Token::new(PlusToken, "+".to_string(), 0, 0));
        assert_eq!(
            tokens[19],
            Token::new(FloatPointToken, "2.5".to_string(), 0, 0)
        );
        assert_eq!(
            tokens[20],
            Token::new(RightParenthesisToken, ")".to_string(), 0, 0)
        ...
        assert_eq!(
            tokens[22],
            Token::new(FloatPointToken, "3.3".to_string(), 0, 0,)
        );
        assert_eq!(
            tokens[23],
            Token::new(SemicolonToken, ";".to_string(), 0, 0)
        ...
        assert_eq!(
            tokens[24],
            Token::new(FloatPointToken, "1.3".to_string(), 0, 0)
        );
