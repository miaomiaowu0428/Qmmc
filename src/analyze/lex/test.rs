...
mod tests {
    ...
    use crate::analyze::lex::token::TokenType::{AndKeyword, EndLineToken, FalseKeyword, FloatPointToken, IntegerToken, LeftParenthesisToken, OrKeyword, PlusToken, RightParenthesisToken, SemicolonToken, SlashToken, StarToken, TrueKeyword};
