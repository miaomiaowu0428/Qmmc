...
impl Runtime {
    ...
    //     }
    // }
    // pub fn evaluate(&self, expressions: Vec<CheckedExpression>) -> Vec<Value> {
    ...
    // }
    //
    // pub fn evaluate_expression(&self, expression: CheckedExpression) -> Result<Value, ControlCommand> {
    //     match expression {
    ...
    //         VarDeclare { name: identifier, init_expr: expression } => {
    ...
    //         CheckedExpression::CallBuiltIn { name, arguments } => self.call_built_in(name, arguments),
    //         CheckedExpression::FunType { .. } => Ok(Value::None),
    //     }
    // }
    //
    // fn evaluate_function_declaration(&self, name: Token, function: FunctionDeclare) -> Result<Value, ControlCommand> {
    ...
    //
    //
    // fn evaluate_binary_expression(&self, left: CheckedExpression, op: BinaryOperator, right: CheckedExpression) -> Value {
    ...
    // }
    //
    // fn evaluate_unary_expression(&self, op: UnaryOperator, operand: CheckedExpression) -> Value {
    ...
    // }
    //
    // fn call_built_in(&self, identifier_token: Token, arguments: Vec<CheckedExpression>) -> Result<Value, ControlCommand> {
    ...
    // }
    //
    // fn evaluate_function_call(&self, identifier_token: Token, arguments: Vec<CheckedExpression>) -> Result<Value, ControlCommand> {
    ...
    // }
    //
    // pub fn evaluate_block(&self, block: Vec<CheckedExpression>) -> Result<Value, ControlCommand> {
    ...
    // }
    //
    // fn evaluate_while_expression(&self, condition: CheckedExpression, block: Vec<CheckedExpression>) {
    //     let child_evaluator = self.new_child();
    ...
    // }
    //
    // pub fn evaluate_assignment(&self, identifier_token: Token, expression: CheckedExpression) -> Value {
